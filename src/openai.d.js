...
/**
 * Representa a un asistente virtual diseñado para ser un tutor de matemáticas.
 * @typedef {Object} Assistant
 * @property {string} id - El identificador único del asistente.
 * @property {string} object - Tipo del objeto, que en este caso es 'assistant'.
 * @property {number} created_at - Timestamp de la creación del asistente.
 * @property {string} name - Nombre del asistente.
 * @property {?string} description - Descripción del asistente, puede ser nula.
 * @property {OpenAIModels} model - Modelo del asistente.
 * @property {string} instructions - Instrucciones sobre cómo debe comportarse el asistente.
 * @property {Tool[]} tools - Herramientas disponibles para el asistente.
 * @property {string[]} file_ids - IDs de archivos asociados con el asistente, si los hay.
 * @property {Object} metadata - Metadatos adicionales del asistente.
 */

/* los tipos de tools son interplete, retrival, y functions*/
/**
 * @typedef {Object} Tool
 * @property {enum {"code_interpreter" | "retrieval" | "function"}} type - Tipo de herramienta.
 */
